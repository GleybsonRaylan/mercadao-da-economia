...
const Ofertas = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-slate-50 via-white to-orange-50/20">
      ...
      {/* HERO SECTION */}
      <section className="py-12 md:py-16 transition-all duration-500 bg-gradient-to-b from-orange-50/50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium bg-orange-50 text-orange-600">
        ...
        {loading ? (
          ...
          <>
            {visibleProducts.length > 0 ? (
                ...
                {page < totalPages && (
                  <div className="text-center mt-10">
                    <button
                      ...
                      className="font-medium px-8 py-3 rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 bg-gradient-to-r from-orange-500 to-red-500 text-white"
                    >
                      Ver mais ofertas 🛒
                    </button>
                  </div>
              ...
              >
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full text-3xl mb-4 bg-orange-50">
                  🔍
                </div>
                ...
                <button
                  onClick={handleClearFilters}
                  className="px-6 py-2 text-white rounded-xl text-sm font-medium shadow-md hover:shadow-lg transition-all bg-gradient-to-r from-orange-500 to-red-500"
                >
                  Limpar filtros
                </button>
              </motion.div>
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-10 h-10 rounded-xl text-white shadow-lg flex items-center justify-center hover:shadow-xl transition-all bg-gradient-to-r from-orange-500 to-red-500"
          >
